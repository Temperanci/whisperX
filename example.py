# import whisperx
from whisperx.translate.llamaapitest1 import translate2ch
import os
from pathlib import Path
from whisperx.translate.movie2audio import extract_audio
from whisperx.translate.srt2ass import srt_to_ass

ROOTDIR = Path(r"D:/Project/whisperX/whisperx/translate/example")
...
for i in os.listdir(ROOTDIR):
    if i.endswith('.mp4'):
        ...
        # 将srt文件转换为ass文件
        # srt_file_path = audio_file_path.replace('.wav', '.srt')
        # ass_file_path = audio_file_path.replace('.wav', '.ass')
